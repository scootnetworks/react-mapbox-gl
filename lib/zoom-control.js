...
var ZoomControl = (function (_super) {
    ...
    ZoomControl.prototype.render = function () {
        var _a = this.props, position = _a.position, style = _a.style;
        var hover = this.state.hover;
        return (React.createElement("div", { style: __assign({}, containerStyle, positions[position], style) },
            React.createElement("button", { style: __assign({}, buttonStyle, buttonStylePlus, (hover === PLUS ? buttonStyleHovered : {})), onMouseOver: this.plusOver, onMouseOut: this.onMouseOut, onClick: this.onClickPlus }),
            React.createElement("button", { style: __assign({}, buttonStyle, buttonStyleMinus, (hover === MINUS ? buttonStyleHovered : {})), onMouseOver: this.minusOver, onMouseOut: this.onMouseOut, onClick: this.onClickMinus })));
    };
    return ZoomControl;
}(React.Component));
